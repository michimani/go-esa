...
func Test_TeamsGetResponse_SetRateLimitInfo(t *testing.T) {
	resetTimestamp := gesa.Timestamp(100000000)

	cases := []struct {
		name string
		h    http.Header
		want *types.TeamsGetResponse
	}{
		{
			name: "normal",
			h: http.Header{
...
func Test_TeamsTeamNameGetResponse_SetRateLimitInfo(t *testing.T) {
	resetTimestamp := gesa.Timestamp(100000000)

	cases := []struct {
		name string
		h    http.Header
		want *types.TeamsTeamNameGetResponse
	}{
		{
			name: "normal",
			h: http.Header{
